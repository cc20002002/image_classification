...
\textsc{mnist} &&0.94  & 0.003              & (0.939,0.942)     &   \\
&&0.942 & 0.003              & (0.941,0.944)     &\\
\midrule
&&0.835 & 0.004              & (0.833,0.837)     &  \\
\textsc{cifar}&&0.844 & 0.005              & (0.841,0.846)     &  \\
...
with \textsc{pca}  &Relabelling& 0.802 & 0.013              & (0.797,0.809)     & \\ 
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}
	%\includegraphics[scale=0.9]{boxplot}
	\centering
    \includegraphics[scale=0.7]{boxplot}%maybe use the large one
	\caption{Box plots of the accuracy results against running time. {\color{red}Describe various lines and the dots as well as colours here. }
}
	\label{fig:Boxplot}
\end{figure}
...
\midrule
 ...
 with \textsc{pca} &  $A_2=A_3$  & 1 & 0 & Reject\\
\bottomrule
\end{tabular}
